...
void ckks_add_const(CKKSContext *ctx, cipher_t *c2, cipher_t *c1, double val);

cipher_t* ckks_add_const(CKKSContext *ctx, cipher_t *c1, double val);


void ckks_mul_const(CKKSContext *ctx, cipher_t *c2, cipher_t *c1, double val);

cipher_t* ckks_mul_const(CKKSContext *ctx, cipher_t *c1, double val);
