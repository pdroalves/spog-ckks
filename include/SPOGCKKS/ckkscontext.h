...
class CKKSContext : public Context{
    ...
    public: 
        ...
        CKKSContext() : Context(){
            ...
            maclaurin_coeffs.insert(pair<string, double*>(
                SIGMOID,
                new double[11]{(double)1./2,(double)1./4,(double)0,(double)-1./48,(double)0,(double)1./480,(double)0,(double)-17./80640,(double)0,(double)31./1451520,0}
                )
            );
